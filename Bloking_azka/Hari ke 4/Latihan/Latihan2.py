...
class UIandFunction:
    ...
    def frameTop(self, root, Basecolor):
        ...
        lb_title = Label(frameleft, text="APLIKASI PARKIR AZKA NAWWAF                          ", bg=Basecolor)
        lb_title.config(font=("Arial", 10, BOLD))
        lb_title.pack()
        ...
        self.btn_search = btn_search = Button(frameleft, text="Cari", activebackground="Cyan", activeforeground="blue")
        ...
        self.btn_save = btn_save = Button(frameleft, text="Simpan", activebackground="Cyan", activeforeground="blue")
        ...
        lb_table1 = Label(frameleft, text="List Pelanggan Urut Terakhir Keluar", bg=Basecolor, fg="cyan")
        lb_table1.config(font=("Arial", 12, BOLD))
        ...
        lb_title_bayar = Label(frameright, text="Biaya Parkir Per Jam", fg="cyan", bg=Basecolor)
        lb_title_bayar.config(font=("Arial", 12, BOLD))
        lb_title_bayar.place(x=0, y=70)
        lb_bayar = Label(frameright, text="Rp 3.000", fg="cyan", bg=Basecolor)
        lb_bayar.config(font=("Arial", 42, BOLD))
        lb_bayar.place(x=0, y=90)
        lb_table2 = Label(frameright, text="List Pelanggan Banyak Bayar", bg=Basecolor, fg="cyan")
    ...
    def tableGrid(self, indikator, frame, data_list):
        ...
        for i in range(len(data_list_update)):
            for j in range(len(data_list_update[0])):
                e = Entry(frame, width=12, fg='cyan', font=('Arial', 10))
